...
export class GuestPageComponent implements OnInit {
  ...
  constructor(private router: Router, private restaurants_service: RestaurantsService, private users_service: UsersService, private reservations_service: ReservationsService){}
  ...
  ngOnInit(): void {
    ...
    this.reservations_service.num_of_reservations_last24h().subscribe(
      data => {
        if(data != null){
          this.num_of_reservations_last24h = data;
        }
      }
    )

    this.reservations_service.num_of_reservations_last7d().subscribe(
      data => {
        if(data != null){
          this.num_of_reservations_last7d = data;
        }
      }
    )

    this.reservations_service.num_of_reservations_last1m().subscribe(
      data => {
        if(data != null){
          this.num_of_reservations_last1m = data;
        }
      }
    )
  }
